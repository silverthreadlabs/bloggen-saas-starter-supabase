                          ...
                          {product.prices?.map((price: Price) => {
                            ...
                            return (
                              <div key={price.id} className="mb-6 last:mb-0">
                                ...
                                <button
                                  className={`
                                    w-full py-4 px-6 rounded-xl font-semibold text-base transition-all duration-300 shadow-sm hover:shadow-md
                                    ${isPopular || isCurrentPlan
                                      ? 'bg-primary-solid hover:bg-primary-solid-hover text-primary-on-primary'
                                      : 'bg-canvas-bg-active hover:bg-canvas-bg-hover text-canvas-text-contrast border border-canvas-border'
                                    }
                                    ${priceIdLoading === price.id ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer'}
                                  `}
